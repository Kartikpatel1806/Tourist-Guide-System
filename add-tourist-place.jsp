		...
		<div class="w3l-book-9">
			<div class="main-top">
				<div class="wrapper padding-bord">
					...
					<form action="AddTourPlace" method="post"
						...
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
								...
								<%
									String tid = DatabaseConnection.generateTourPlaceId();
								%>
								<input type="text" name="tid" class="input" value="<%=tid%>"
									readonly />
							</div>
							<div class="ele-9its_grid">
								<p class="text-left">
								...
								<input type="text" name="tname" class="input" value="" />
							</div>
						...
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
								...
								<input type="text" name="taddress" class="input" value="" />
							</div>
							<div class="ele-9its_grid">
								<p class="text-left">
									<strong>Tourist Area</strong>
								</p>
								<input type="text" name="tarea" class="input" value="" />
							</div>
						</div>
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
								...
								<input type="text" name="ttags" class="input" value="" />
							</div>
							<div class="ele-9its_grid">
								<p class="text-left">
									<strong>Tourist Place Description</strong>
								</p>
								<input type="text" name="tdesc" class="input" value="">
							</div>
						</div>
						<div class="d-grid grid-col-1">
							<div class="ele-9its_grid">
								<p class="text-left">
									<strong>Tourist Place Image</strong>
								</p>
								<input type="file" name="timage" class="input" value="" />
							</div>
						</div>
						<div class="d-grid grid-col-1">
							<div class="ele-9its_grid">
