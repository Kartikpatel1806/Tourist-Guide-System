...
<body>
		...
		<div class="container agile-banner_nav">
			<div class="row header-top">
				...
				<div class="col-md-7 top-right p-0">
					<p>
						<i class="fa fa-map-marker" aria-hidden="true"></i>Tourist Guide
						System
					</p>
				</div>
			</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h3>
					<a class="navbar-brand" href="index.jsp">Tourist Guide System</a>
				</h3>
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="dropdown nav-item"><a href="#"
							class="dropdown-toggle nav-link" data-toggle="dropdown">More
								<b class="caret"></b>
						</a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="destinations-places.jsp">Destinations</a></li>
								<li><a href="knowIndia.jsp">Know India</a></li>
	...
	<div class="slider">
						...
						<div class="layer">
							<div class="container">
								<div class="banner-info_agile_w3ls">
									<h2>
										Travel Things go as <span> per plan</span>.
									</h2>
					...
					<div class="banner-top1">
						<div class="layer">
							<div class="container">
								<div class="banner-info_agile_w3ls">
									<h3>
										Best travel website <span> Inspire</span> You.
									</h3>
									<p>Holiday packages and special deals.</p>
								</div>
							</div>
					...
					<div class="banner-top2">
						<div class="layer">
							<div class="container">
								<div class="banner-info_agile_w3ls">
									<h3>
										Lets Find Some <span>Beautiful</span> Place.
									</h3>
									<p>Holiday packages and special deals.</p>
								</div>
							</div>
					...
					<div class="banner-top3">
						<div class="layer">
							<div class="container">
								<div class="banner-info_agile_w3ls">
									<h3>
										Travelling Is like <span>Breathing</span>.
									</h3>
									<p>Holiday packages and special deals.</p>
								</div>
							</div>
		...
		<div class="w3_agileits_social_media">
			<ul>
				<li><a href="" class="wthree_facebook" target="_blank"><i
						class="fa fa-facebook" aria-hidden="true"></i></a></li>
				<li><a href="" class="wthree_twitter" target="_blank"><i
	...
	<section class="welcome py-5">
		<div class="container py-3">
			...
			<div class="row welcome-grids">
				<div class="col-lg-6">
					<h4 class="mb-3">welcome to the Tourist Guide System</h4>
					<h3>Remember that happiness is a way of travel, not a
						destination.</h3>
					<p class="my-4">Tourist Guide System is the movement of people
						...
						trip. Travel can also include relatively short stays between
						successive movements, as in the case of tourism.</p>
				</div>
			...
			<div class="row inner-sec">
				<div class="col-lg-4 col-md-6 news-left">
					<ul id="demo1_thumbs" class="list-inline">
						<li><a href="images/banner1.jpg"> <img
								src="images/b1.jpg" alt=""
								data-desoslide-caption="<h3>Latest Post 1</h3>">
								<div class="mid-text-info">
									<h4>She has no filter and is such a warm hearted
										individual.</h4>
									<p class="font-italic">posted 2 days ago</p>
								</div>
						</a></li>
						<li><a href="images/banner4.jpg"> <img
								src="images/b4.jpg" alt=""
								data-desoslide-caption="<h3>Latest Post 4</h3>">
								<div class="mid-text-info">
									<h4>He's created his own travel show through Snapchat.</h4>
									<p class="font-italic">posted 2 days ago</p>
								</div>
						</a></li>
						<li><a href="images/banner2.jpg"> <img
								src="images/b2.jpg" alt=""
								data-desoslide-caption="<h3>Latest Post 2</h3>">
								<div class="mid-text-info">
									<h4>His photography has also been published in Beautiful
										Destination.</h4>
									<p class="font-italic">posted 2 days ago</p>
								</div>
						</a></li>
				...
				<div class="row agileits_team_grids">
					<div class="col-lg-3 col-sm-6 agileits_team_grid">
						<div class="agileits_team_grid_figure">
							<img src="images/guide1.jpg" alt=" " class="img-responsive" />
						</div>
						...
						<div class="clearfix"></div>
						<h4>
							Kishor Kadam <span>guide</span>
						</h4>
						<p>Help the client to giving tour place information.</p>
					</div>
					<div class="col-lg-3 col-sm-6 agileits_team_grid">
						<div class="agileits_team_grid_figure">
							<img src="images/guide2.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="agileits_team_grid_figure_social">
							<ul class="w3ls_social">
								<li><a href="#" class="w3_agile_facebook"><i
					...
					<div class="col-lg-3 col-sm-6 agileits_team_grid">
						<div class="agileits_team_grid_figure">
							<img src="images/guide3.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="agileits_team_grid_figure_social">
							<ul class="w3ls_social">
								<li><a href="#" class="w3_agile_facebook"><i
					...
					<div class="col-lg-3 col-sm-6 agileits_team_grid">
						<div class="agileits_team_grid_figure">
							<img src="images/guide4.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="agileits_team_grid_figure_social">
							<ul class="w3ls_social">
								<li><a href="#" class="w3_agile_facebook"><i
	...
	<footer class="py-5">
		<div class="container py-md-3">
			...
			<div class="subscribe-grid text-center">
				<p class="para three mt-4">Travel is the movement of people
					between distant geographical locations. Travel can be done by foot,
					bicycle, automobile, train, boat, bus, airplane, ship or other
				...
				<p>
					Get <span>10%</span> off on booking
				</p>
	...
	<section class="copyright py-4 text-center">
		<div class="container">
			<p>
				© 2020 In Tourist Guide System. All Rights Reserved | Design by <a
					href="" target="=_blank"> ABC </a>
			</p>
		</div>
	</section>
	<!-- //copyright -->
