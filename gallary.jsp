...
<body>
	...
	<div class="gallery py-5">
		<div class="container py-sm-3">
			<h2 class="heading text-center mb-sm-5 mb-4">Our Gallery</h2>
				...
				<div class="col-md-4 gallery-grids">
					<div class="galry-grid grid-top-rgt">
						<a href="images/g7.jpg" class="showcase"
							...
							title="Travel Destinations"> <img src="images/g7.jpg" alt=""
					...
					<div class="galry-grid grid-top-rgt galry-bottom-mdl">
						<a href="images/img1.jpg" class="showcase"
							data-rel="lightcase:myCollection:slideshow"
							title="Travel Destinations"> <img src="images/g8.jpg" alt=""
							class="img-responsive zoom-img">
							<div class="w3agile-text w3agile-text-small1">
								<h5>In Travel</h5>
							</div>
					...
					<div class="galry-grid galry-w3btm">
						<a href="images/g6.jpg" class="showcase"
							data-rel="lightcase:myCollection:slideshow"
							title="Travel Destinations"> <img src="images/g6.jpg" alt=""
							class="img-responsive zoom-img">
				...
				<div class="col-md-8 mt-md-0 mt-4 pl-md-2 pl-0 gallery-grids">
					<div class="galry-grid glry-one">
						<div class="glry-two mb-md-0 mb-3 glry-left">
							<a href="images/g1.jpg" class="showcase"
								data-rel="lightcase:myCollection:slideshow"
								title="Travel Destinations"> <img src="images/g1.jpg" alt=""
								class="img-responsive zoom-img">
								<div class="w3agile-text">
									<h5>In Travel</h5>
								</div>
						...
						<div class="glry-two glry-right">
							<a href="images/g3.jpg" class="showcase"
								data-rel="lightcase:myCollection:slideshow"
								title="Travel Destinations"> <img src="images/g3.jpg" alt=""
								class="img-responsive zoom-img">
								<div class="w3agile-text w3agile-text-small">
									<h5>In Travel</h5>
								</div>
							</a> <a class="w3ls-bottom-img showcase" href="images/g4.jpg"
								data-rel="lightcase:myCollection:slideshow"
								title="Travel Destinations"> <img src="images/g4.jpg" alt=""
								class="img-responsive zoom-img">
								<div class="w3agile-text w3agile-text-small">
									<h5>In Travel</h5>
								</div>
					...
					<div class="galry-grid glly-bottm">
						<div class="glry-two glry-right">
							...
							</a> <a class="w3ls-bottom-img showcase" href="images/g3.jpg"
								data-rel="lightcase:myCollection:slideshow"
								title="Travel Destinations"> <img src="images/g3.jpg" alt=""
								class="img-responsive zoom-img">
								<div class="w3agile-text w3agile-text-small">
						...
						<div class="glry-two glry-left">
							<a href="images/g5.jpg" class="showcase"
								data-rel="lightcase:myCollection:slideshow"
								title="Travel Destinations"> <img src="images/g5.jpg" alt=""
								class="img-responsive zoom-img">
								<div class="w3agile-text">
									<h5>In Travel</h5>
								</div>
	...
	<section class="copyright py-4 text-center">
		<div class="container">
			<p>
				© 2020-2021 In Tourist Guide System. All Rights Reserved | Design by
